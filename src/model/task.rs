...
impl TaskBmc {
    ...
    pub async fn update(_ctx: &Ctx, _mm: &ModelManager, _id: i64, _title: String) -> Result<Task> {
        todo!()
    }
...
mod tests {
    ...
    async fn test_list_ok() -> Result<()> {
        ...
        let tasks: Vec<Task> = tasks
            ...
            .collect();
        assert_eq!(tasks.len(), 3, "Number of seeded tasks not matching");
